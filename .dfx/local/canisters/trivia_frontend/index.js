...
import { idlFactory } from './trivia_frontend.did.js';
export { idlFactory } from './trivia_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRIVIA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trivia_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trivia_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trivia_frontend.did.js")._SERVICE>}
 */
export const trivia_frontend = createActor(canisterId);
