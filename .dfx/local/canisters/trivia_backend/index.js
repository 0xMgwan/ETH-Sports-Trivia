...
import { idlFactory } from './trivia_backend.did.js';
export { idlFactory } from './trivia_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRIVIA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trivia_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trivia_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trivia_backend.did.js")._SERVICE>}
 */
export const trivia_backend = createActor(canisterId);
